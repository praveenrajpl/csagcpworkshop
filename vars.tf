...
variable "project" {
  type    = string
  default = "praveen-project-166400"
}
variable "credentials_file_path" { 
  default = "/Users/plokesh/Downloads/praveen-project-166400-2365dc9f4423.json"

}
variable "service_account" {
  default = "csaworkshop@praveen-project-166400.iam.gserviceaccount.com"
}
